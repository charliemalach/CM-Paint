 ...
 * save and save as images. Auto-save has also been implemented. These images
 * can be drawn upon and saved as new files. Users can use the following tools:
 * Line, Dotted Line, Pencil, Square, Rectangle, and more. More features will
 * come in the future.
...
public class Paint extends Application {
    ...
    public final static String IMAGES = new File("resources/images/").getAbsolutePath();
    public final static String Logger = new File("resources/logger/").getAbsolutePath();
    public static File log = new File(Logger + "log.txt"); // new logger file containing log data
    ...
    public void start(Stage stage) throws IOException {
        ...
        // Starts scene
        scene = new Scene(pane, windowWidth, windowHeight); // creates a new scene with the main Grid Pane and the
                                                            // desired application window size.
    ...
    public static void removeCurrentTab() {
        ...
        logData(" user removed current tab");
    }
}