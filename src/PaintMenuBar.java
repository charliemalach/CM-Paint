 ...
 * This class file is used to manage the menu bar and all the relevant menu bar
 * events.
 **/
...
public class PaintMenuBar extends MenuBar {
    ...
    public PaintMenuBar() {
        ...
        Open.setAccelerator(new KeyCodeCombination(KeyCode.O, KeyCombination.CONTROL_DOWN)); // sets hotkey CTRL + O
        ...
        Save.setAccelerator(new KeyCodeCombination(KeyCode.S, KeyCombination.CONTROL_DOWN)); // sets hotkey CTRL + S
        ...
        // 'Save as' menu item. Allows users to save current project as a different
        // file.
        MenuItem SaveAs = new MenuItem("Save as..."); // Creates menu option to save current user project as different
                                                      // file
        ...
        // 'Exit' menu item. Allows users to exit current project after prompting them
        // to save.
        ...
        About.setAccelerator(
                new KeyCodeCombination(KeyCode.F1, KeyCombination.SHIFT_DOWN)); // sets hotkey Shift + F1
        About.setOnAction(e -> {
            ...
            logData(" user viewed the About Paint");
        });

        // 'Help' menu item. Allows users to browse a 'Q&A' section about the
        // application.
        MenuItem helpOption = new Menu("Help");
        helpOption.setMnemonicParsing(
                true);
        helpOption.setAccelerator(
                new KeyCodeCombination(KeyCode.H, KeyCombination.SHIFT_DOWN)); // sets hotkey Shift + H
        helpOption.setOnAction(e -> {
            ...
            String text = "Q: How do I open an image?\n" +
